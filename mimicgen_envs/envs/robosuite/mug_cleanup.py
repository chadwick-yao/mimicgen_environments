...
class MugCleanup(SingleArmEnv_MG):
    ...
    def reward(self, action=None):
        ...
        drawer_open = self.sim.data.qpos[self.drawer_qpos_addr] <= -0.13
        grip_overhead = self.sim.data.site_xpos[self.grip_site_id][2] >= 0.935
        ...
        # check for placing object in drawer (stage 3)
        ...
        drawer_closed = self.sim.data.qpos[self.drawer_qpos_addr] > -0.005
    ...
    def _get_object_model(self):
        ...
        base_mjcf_path = os.path.join(
            mimicgen_envs.__path__[0], "models/robosuite/assets/shapenet_core/mugs"
        )
